---
title: "01_mpa_shum_adults_simdig_2"
output: html_document
---

## Running simulations with this model with 5 adults and 5 pediatrics datasets


## Corresponds to MMF -> literature -> 01_Model
## Originally Model_MPA_01.Rmd under IMMS -> lab-notebook -> MMF 

## ** Population pharmacokinetic analysis of MPA in renal transplant recipients folloiwng oral administration of MMF **
## B. Shum
## 2003, Br J Clin Pharmacol

### Trial Design
* Retrospective, 22 renal transplant patients
* Dose: MMF 1g PO BID
* Co-medications: cyclosporin, prednisone. Exact doses were not specified in paper.
* Sampling strategy: Full 12-hour plasma concentration-time profiles of MPA were obtained from 10 patients on 3 occasions, Days 2, 5, and 28 post-transplant. 14 whole blood samples were collected on each occasion @ pre-dose, 0.25, 0.5, 0.75, 1, 1.25, 1.5, 2, 3, 4, 6, 8, 10, 12 hrs post-dose. In 12 other patients, blood samples were collected on only day 2 post-transplant. 


### Patient demographics: mean +/- sd (range)
* Age (yrs): 42 ± 16 (26–65)
* Gender: F=4,M=7
* Weight (kg): 74.2 ± 17.7 (58.3–110)
* Albumin (g l-1): 35 ± 4.4 (29–42)
* Serum creatinine (mM): 0.24 ± 0.15 (0.12–0.61)
* Donor status: C=13,LR=5,LNR=1 19; C=cadaver, LR=living related, LNR=living unrelated
     

### Model structure
* 2-compartment model with a lag time in the absorption phase and between occasion variability (BOV)
...
model <- models$use("01_mpa_shum_adults")
