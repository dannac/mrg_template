---
title: "05_mpa_vanhest_adults_simdig_2"
output: html_document
---

## Corresponds to paper in MMF -> literature -> 05_Model
## Originally Sim_MPA_Conc_05_AS.Rmd in IMMS -> lab-notebook -> MMF

## ** Population Pharmacokinetics of Mycophenolic Acid in Renal Transplant Recipients **
## van Hest, Reinier
## 2005, Clin Pharmacokinet


### Trial Design
* Retrospective study, 140 renal transplant patients who participated in the RCCT;
* Three MPA AUC target groups: low (AUC 16.1 mgxh/L), intermediate (AUC 32.2 mgxh/L) and high(AUC 60.6 mgxh/L);
* Starting MMF dose were 450mg BID, 950 mgBID and 1700mg BID for these three AUC target groups;
* All patients receive ciclosporin and corticosteroids as concomitant immunosuppressive therapy according to routine practice.
* Sampling: nine occasions on days 3, 7, 11, 21, 28, 56, 84, 112 and 140 after transplantation; 0.33, 0.66, 1.25, 2, 5, 8, and 12 hours on first three sampling days and 0.33, 0.66, 1.25 and 2 hours on subsequent sampling days

### Model Structure
* 2-compartment model with first-order absorption;
* CL = TVCL*pow(CLCR/48,-0.12)*pow(Alb/30,-1.07)*pow(CsA/450,0.31)*pow(1.11,gender)*exp(ECL)
* Vc = TVVc*pow(CLCR/48,-0.62)*pow(Alb/30,-1.13)*exp(EVc);


### Simulated dosing regimen
three occasions: Day 3, Day28 and Day 140 after kidney transplantation

dosing regimen1: 450mg BID Oral for 3 days
dosing regimen2: 950mg BID Oral for 3 days
dosing regimen3: 1700mg BID Oral for 3 days
...
model <- models$use("05_mpa_vanhest_adults")
