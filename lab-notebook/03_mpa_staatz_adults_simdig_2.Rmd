---
title: "03_mpa_staatz_adults_simdig_2"
output: html_document
---

## ** Population pharmacokinetics of mycophenolic acid during the first week after renal transplantation **
## C. Staatz
## 2005, Eur J Clin Pharmacol

### Trial Design
* Retrospective, 117 renal transplant patients
* Dose: MMF 1g PO BID
* Co-medications: corticosteroid and either cyclosporine or tacrolimus. Exact doses were not specified in paper.
* Sampling strategy: Blood samples collected at t=0 (trough, pre-dose), 1, 2, 3 and 4 h after dosing. These samples were collected as part of routine clinical care on days 3, 5 and 7 post-transplant. 
...
* Gender: F=45,M=72
* Weight (kg): 81 (37–134)
* Albumin (g l-1): 26 (6–44)
* Serum creatinine (mmol/L): 0.15(0.06-1.03)
* Clcr(mL/min): 55(7.6-179) -> convert to L/hr: 3.3(0.456-10.74)
* Transplant type: 90 cadaveric, 27 living-related
* Transplant number: 100 first, 16 second, 1 fourth
* Concentrations (mg/L): 3.2(0.4-24.2)
     

### Model structure
* Bi-exponential elimination model with first-order absorption and proportional residual error 
* Final model: CL/F=theta1*(1+theta2*(alb-26))*(1+theta3*fkcy) (l/h); fkcy=0 if cyclosporine, fkcy=1 if tacrolimus


### Final model parameters
* CL/F=25.4 L/h (tacrolimus co-therapy), CL/F=34.9 L/h (cyclosporine co-therapy) 
* Median albumin concentration=26 g/L
* V1/F=65 L, V2/F=496 L
* ka=0.64 h, Q/F=30 L/h. 
* Between-subject variability: CL/F=32%, ka=109% and Q/F=78% 
* Between-occasion variability in CL/F was 35% 
* Residual random error=41% 

### Simulation
* MMF 1g PO Q12H, addl=5


### Enterohepatic circulation
* MPA concentrations were only measured between 0 h and 4 h post-dose and EHPC happens between 4 and 12 hours post-dose so EHPC were not modelled in the paper.
...
model <- models$use("03_mpa_staatz_adults")
